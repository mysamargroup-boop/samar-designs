...
const productClientCode = `"use client";
...
const productPageCode = `import ProductDetailClient from './ProductDetailClient';
...
const collectionsClientCode = productClientCode.replace('ProductDetailClient', 'CollectionProductDetailClient');
const collectionsPageCode = `import CollectionProductDetailClient from './CollectionProductDetailClient';
import productsDataStatic from "@/lib/products.json";
...
fs.writeFileSync(path.join(__dirname, 'src/app/(site)/products/[id]/ProductDetailClient.tsx'), productClientCode);
fs.writeFileSync(path.join(__dirname, 'src/app/(site)/products/[id]/page.tsx'), productPageCode);

fs.writeFileSync(path.join(__dirname, 'src/app/(site)/collections/[category]/[sub]/[id]/CollectionProductDetailClient.tsx'), collectionsClientCode);
fs.writeFileSync(path.join(__dirname, 'src/app/(site)/collections/[category]/[sub]/[id]/page.tsx'), collectionsPageCode);

console.log('Files written directly using Node fs');
