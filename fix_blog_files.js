...
const blogPageCode = `import BlogDetailClient from './BlogDetailClient';
...
fs.writeFileSync(path.join(__dirname, 'src/app/(site)/blog/[id]/BlogDetailClient.tsx'), blogClientCode);
fs.writeFileSync(path.join(__dirname, 'src/app/(site)/blog/[id]/page.tsx'), blogPageCode);

console.log('Blog files written direction using Node fs');
