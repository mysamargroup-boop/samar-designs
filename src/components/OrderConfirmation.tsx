                    ...
                    <tbody>
                        {orderData.items.map((item, idx) => (
                            <tr key={idx}>
                                ...
                                <td style={{ padding: '18px 10px', borderBottom: '1px solid #f5f5f5', color: '#999', fontWeight: 500, fontSize: '11px', fontFamily: '"Courier New", monospace' }}>{generateSKU(item.name, idx)}</td>
