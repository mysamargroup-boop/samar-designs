...
export default function CategorySection({ collection, index }: CategorySectionProps) {
                        ...
                        <div className="relative aspect-[4/5] w-full max-w-lg mx-auto rounded-[2rem] overflow-hidden shadow-2xl border-2 border-white transition-transform duration-700 group-hover:scale-[1.02]">
                            {collection.imageUrl ? (
                                ...
                                <div className="w-full h-full bg-primary/5 flex items-center justify-center">
                                    <span className="text-primary/20 font-black uppercase tracking-widest text-xs">{collection.name}</span>
                                </div>
                            )}
