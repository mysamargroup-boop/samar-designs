...
import { MessageCircle, Sparkles, ChevronRight, PanelsTopLeft, ShoppingBag, Truck, MousePointer2, Flower2 } from 'lucide-react';
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="flex items-center justify-between mb-12">
            <h4 className="text-sm font-bold uppercase tracking-widest text-foreground">Featured Works</h4>
      ...
      <section className="py-20 px-4 bg-white/40">
        <div className="container mx-auto max-w-2xl">
          <div className="bg-white p-12 rounded-2xl shadow-sm text-center border border-gray-100 space-y-6">
            ...
            <h4 className="text-sm font-bold uppercase tracking-[0.2em] text-foreground">The Philosophy</h4>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <h4 className="text-xs font-bold text-center mb-16 uppercase tracking-[0.2em] text-foreground">The Experience</h4>
